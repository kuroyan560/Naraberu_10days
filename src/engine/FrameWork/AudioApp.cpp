...
KuroEngine::AudioApp* KuroEngine::AudioApp::s_instance = nullptr;

using namespace std;

KuroEngine::AudioApp::AudioApp()
{
...
void KuroEngine::AudioApp::Update()
{
...
bool KuroEngine::AudioApp::NowPlay(const int& Handle)
{
...
void KuroEngine::AudioApp::ChangeVolume(const int& Handle, float Volume)
{
	auto itr = m_audios.begin();
	for (int i = 0; i < Handle; i++)
	{
...
float KuroEngine::AudioApp::GetVolume(const int& Handle)
{
	auto itr = m_audios.begin();
	for (int i = 0; i < Handle; i++)
	{
...
int KuroEngine::AudioApp::LoadAudio(string FileName, const float& Volume)
{
	//if (!audios.empty())
	//{
	//	int i = 0;
...
int KuroEngine::AudioApp::PlayWave(const int& Handle, bool LoopFlag)
{
	HRESULT result;
...
void KuroEngine::AudioApp::StopWave(const int& Handle)
{
	auto itr = m_audios.begin();
	for (int i = 0; i < Handle; i++)
	{
...
void KuroEngine::AudioApp::AudioData::Unload()
{
