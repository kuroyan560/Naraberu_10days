...
namespace EnemysData {
	...
	static const EnemyData Lizard_Level_2 =		EnemyData("lizard_yellow", ENEMY_TAG::DEFAULT, 32, 15, 0, 0, AI_TYPE::DEFAULT, "Attack_01", "Attack_01", "Attack_01");
	static const EnemyData Zako_Level_2 =		EnemyData("zako_yellow", ENEMY_TAG::DEFAULT, 32, 10, 0, 110000, AI_TYPE::JAMMING, "Attack_01", "Jamming_01", "Jamming_01");
