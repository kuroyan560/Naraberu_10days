...
void EnemyActions::EnemyActionMgr::StartAction(std::string Action_Name)
{
	...
	if (m_Now_Action_Name == "Attack_01") {
		EnemyActions::GetPtr<Debug_Attack_01>(m_List[size_t(m_List_Pair[m_Now_Action_Name])])->Param_Set(15, 200);
		...
		EnemyActions::GetPtr<Debug_Attack_02>(m_List[size_t(m_List_Pair[m_Now_Action_Name])])->Param_Set(30, 200);
		...
		EnemyActions::GetPtr<Debug_Heal_01>(m_List[size_t(m_List_Pair[m_Now_Action_Name])])->Param_Set(45, 200);
